...
/**
 * @title The TokenX ERC20 wrapper.
 *
 * @dev The TokenX is a rebasing wrapper for fixed balance ERC-20 tokens.
 *
 ...
 *
 *      The TokenX math is almost identical to Ampleforth's μFragments.
 *
 ...
 *
 */
contract TokenX is ITokenX, Initializable, OwnableUpgradeable {
    ...
    modifier validRecipient(address to) {
        require(to != address(0x0), "TokenX: recipient zero address");
        require(to != address(this), "TokenX: recipient token address");
        _;
    }
    ...
    function initialize(
        ...
        require(underlying_ != address(0), "TokenX: invalid underlying reference");
        ...
        //
        // No more than MAX_UNDERLYING can be deposited into the TokenX contract.
    ...
    function updateOracle(address oracle_) public override onlyOwner {
        ...
        oracle = oracle_;
        (price, valid) = _queryPrice();
        require(valid, "TokenX: unable to fetch data from oracle");
    ...
    function _deposit(
        ...
        require(amount > 0, "TokenX: too few button tokens to mint");
    ...
    function _withdraw(
        ...
        require(amount > 0, "TokenX: too few button tokens to burn");
    ...
    function _queryPrice() private view returns (uint256, bool) {
        uint256 newPrice;
        bool valid;
        (newPrice, valid) = IOracle(oracle).getComplementData();
    ...
    // @dev This is for development purpose not intended to have this feature live
